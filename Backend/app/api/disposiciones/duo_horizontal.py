...
def handle_region(region) -> str:
    ...
    html_content = f"<div style='width: 100%; display: flex; flex-direction: column; justify-content: center; {align_style}'{tts_html}>\n"
...
{codigo_content}
            ...
            if url:
                html_content += f"""
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; max-width: 100%; max-height: 100%;"{tts_html}>
